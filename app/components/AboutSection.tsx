  ...
  <div className="flex flex-col lg:flex-row items-start">
    ...
    <div className="w-full lg:w-1/2 p-8 lg:p-12">
      ...
      <p className="text-base text-gray-300 mb-4">
        ...
        What started as a homemade herbal oil for personal use quickly became something others wanted too. That response transformed EWA into a brand dedicated to scalp health, effectiveness, and trust.
        Every EWA product is crafted with purpose, rooted in experience, and designed to support the health and beauty of your crown.
      </p>
